...
@[deprecated integerNormalization +typeChanged (since := "2026-02-05")]
noncomputable def coeffIntegerNormalization (p : S[X]) (i : ℕ) : R :=
  (integerNormalization M p).coeff i

@[deprecated integerNormalization_support +typeChanged (since := "2026-02-05")]
...
@[deprecated integerNormalization_spec +typeChanged (since := "2026-02-05")]
