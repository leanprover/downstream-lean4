...
lemma Ψ_even (m : ℤ) : W.Ψ (2 * m) * W.ψ₂ =
  ...
  simp_rw [Ψ, preΨ_even, ite_eq_left <| even_two_mul m, Int.even_add, Int.even_sub, even_two, iff_true,
...
lemma Ψ_odd (m : ℤ) : W.Ψ (2 * m + 1) =
  ...
  simp_rw [Ψ, preΨ_odd, ite_eq_right m.not_even_two_mul_add_one, Int.even_add, Int.even_sub, even_two,
...
lemma Φ_four : W.Φ 4 = X * W.preΨ₄ ^ 2 * W.Ψ₂Sq - W.Ψ₃ * (W.preΨ₄ * W.Ψ₂Sq ^ 2 - W.Ψ₃ ^ 3) := by
  rw [show 4 = ((3 : ℕ) + 1 : ℤ) by rfl, Φ_ofNat, preΨ'_four, ite_eq_right <| by decide,
    show 3 + 2 = 2 * 2 + 1 by rfl, preΨ'_odd, preΨ'_four, preΨ'_two, ite_eq_left Even.zero, preΨ'_one,
