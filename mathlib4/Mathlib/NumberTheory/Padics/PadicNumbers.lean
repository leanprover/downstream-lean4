...
theorem AddValuation.map_mul (x y : ℚ_[p]) :
  ...
  · by_cases hy : y = 0
    ...
    · rw [ite_eq_right hx, ite_eq_right hy, ite_eq_right (mul_ne_zero hx hy), ← WithTop.coe_add, WithTop.coe_eq_coe,
        valuation_mul hx hy]
  ...
  · by_cases hx : x = 0
    ...
    · by_cases hy : y = 0
      · rw [hy, ite_eq_left rfl, min_eq_left, add_zero]
        exact le_top
      · rw [ite_eq_right hx, ite_eq_right hy, ite_eq_right hxy, ← WithTop.coe_min, WithTop.coe_le_coe]
