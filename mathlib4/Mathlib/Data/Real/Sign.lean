...
theorem sign_of_pos {r : ℝ} (hr : 0 < r) : sign r = 1 := by rw [sign, ite_eq_left hr, ite_eq_right hr.not_gt]

@[simp]
theorem sign_zero : sign 0 = 0 := by rw [sign, ite_eq_right (lt_irrefl _), ite_eq_right (lt_irrefl _)]
