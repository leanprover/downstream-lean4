...
instance : HasUpperLowerClosure αᵒᵈ := by
  unsealing_newtype OrderDual =>
    exact ⟨@IsLowerSet.closure α _ _ _, @IsUpperSet.closure α _ _ _,
      @IsOpen.lowerClosure α _ _ _, @IsOpen.upperClosure α _ _ _⟩
