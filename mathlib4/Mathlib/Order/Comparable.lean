...
@[deprecated SymmGen.of_rel +typeChanged (since := "2026-01-25")]
theorem CompRel.of_rel (h : r a b) : CompRel r a b :=
  SymmGen.of_rel h

@[deprecated SymmGen.of_rel_symm +typeChanged (since := "2026-01-25")]
theorem CompRel.of_rel_symm (h : r b a) : CompRel r a b :=
  SymmGen.of_rel_symm h

@[deprecated symmGen_swap +typeChanged (since := "2026-01-25")]
theorem compRel_swap (r : α → α → Prop) : CompRel (swap r) = CompRel r :=
  symmGen_swap r

@[deprecated symmGen_swap_apply +typeChanged (since := "2026-01-25")]
theorem compRel_swap_apply (r : α → α → Prop) : CompRel (swap r) a b ↔ CompRel r a b :=
  symmGen_swap_apply r

@[simp, refl, deprecated SymmGen.refl +typeChanged (since := "2026-01-25")]
theorem CompRel.refl (r : α → α → Prop) [Std.Refl r] (a : α) : CompRel r a a :=
  SymmGen.refl r a

@[deprecated SymmGen.rfl +typeChanged (since := "2026-01-25")]
theorem CompRel.rfl [Std.Refl r] : CompRel r a a := SymmGen.rfl

@[deprecated SymmGen.instRefl +typeChanged (since := "2026-01-25")]
instance [Std.Refl r] : Std.Refl (CompRel r) :=
  SymmGen.instRefl

@[symm, deprecated SymmGen.symm +typeChanged (since := "2026-01-25")]
theorem CompRel.symm : CompRel r a b → CompRel r b a :=
  SymmGen.symm

@[deprecated SymmGen.instSymm +typeChanged (since := "2026-01-25")]
instance : Std.Symm (CompRel r) :=
  SymmGen.instSymm

@[deprecated symmGen_comm +typeChanged (since := "2026-01-25")]
theorem compRel_comm {a b : α} : CompRel r a b ↔ CompRel r b a :=
  symmGen_comm

@[deprecated SymmGen.decidableRel +typeChanged (since := "2026-01-25")]
instance CompRel.decidableRel [DecidableRel r] : DecidableRel (CompRel r) :=
  SymmGen.decidableRel

@[deprecated AntisymmRel.symmGen +typeChanged (since := "2026-01-25")]
theorem AntisymmRel.compRel (h : AntisymmRel r a b) : CompRel r a b :=
  AntisymmRel.symmGen h

@[simp, deprecated symmGen_of_total +typeChanged (since := "2026-01-25")]
...
@[deprecated SymmGen.of_le +typeChanged (since := "2026-01-25")]
theorem CompRel.of_le (h : a ≤ b) : CompRel (· ≤ ·) a b := SymmGen.of_le h

@[deprecated SymmGen.of_ge +typeChanged (since := "2026-01-25")]
...
@[deprecated SymmGen.of_lt +typeChanged (since := "2026-01-25")]
theorem CompRel.of_lt (h : a < b) : CompRel (· ≤ ·) a b := SymmGen.of_lt h

@[deprecated SymmGen.of_gt +typeChanged (since := "2026-01-25")]
...
@[trans, deprecated SymmGen.of_symmGen_of_antisymmRel +typeChanged (since := "2026-01-25")]
...
@[deprecated instTransSymmGenLeAntisymmRel +typeChanged (since := "2026-01-25")]
instance : @Trans α α α (CompRel (· ≤ ·)) (AntisymmRel (· ≤ ·)) (CompRel (· ≤ ·)) :=
  instTransSymmGenLeAntisymmRel

@[trans, deprecated SymmGen.of_antisymmRel_of_symmGen +typeChanged (since := "2026-01-25")]
...
@[deprecated instTransAntisymmRelLeSymmGen +typeChanged (since := "2026-01-25")]
instance : @Trans α α α (AntisymmRel (· ≤ ·)) (CompRel (· ≤ ·)) (CompRel (· ≤ ·)) :=
  instTransAntisymmRelLeSymmGen

@[deprecated AntisymmRel.symmGen_congr +typeChanged (since := "2026-01-25")]
...
@[deprecated AntisymmRel.symmGen_congr_left +typeChanged (since := "2026-01-25")]
theorem AntisymmRel.compRel_congr_left (h : AntisymmRel (· ≤ ·) a b) :
    CompRel (· ≤ ·) a c ↔ CompRel (· ≤ ·) b c :=
  AntisymmRel.symmGen_congr_left h

@[deprecated AntisymmRel.symmGen_congr_right +typeChanged (since := "2026-01-25")]
...
/-- A partial order where any two elements are comparable is a linear order. -/
@[deprecated linearOrderOfSymmGen +typeChanged (since := "2026-01-25"), instance_reducible]
...
@[deprecated not_symmGen_iff +typeChanged (since := "2026-01-25")]
...
@[deprecated not_incompRel_iff_symmGen +typeChanged (since := "2026-01-25")]
