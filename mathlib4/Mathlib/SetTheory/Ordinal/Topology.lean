...
@[deprecated SuccOrder.isOpen_singleton_iff +typeChanged (since := "2026-01-20")]
theorem isOpen_singleton_iff : IsOpen ({a} : Set Ordinal) ↔ ¬ IsSuccLimit a :=
  SuccOrder.isOpen_singleton_iff

@[deprecated SuccOrder.nhds_eq_pure +typeChanged (since := "2026-01-20")]
theorem nhds_eq_pure : 𝓝 a = pure a ↔ ¬ IsSuccLimit a :=
  SuccOrder.nhds_eq_pure

@[deprecated SuccOrder.isOpen_iff +typeChanged (since := "2026-01-20")]
...
@[deprecated SuccOrder.isSuccLimit_of_mem_frontier +typeChanged (since := "2026-01-20")]
